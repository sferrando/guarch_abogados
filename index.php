...
<html>
  <head>
    ...
    <meta property="og:description" content="Guarch abogados - Bufete de abogados localizado en Valencia.">
    ...
    <div class="container">
      ...
      <div id="myCarousel" class="carousel slide" data-ride="carousel">
        ...
        <ul class="nav nav-pills nav-justified">
          <li data-target="#myCarousel" data-slide-to="0" class="active"><a href="#">TRÁFICO<small></small></a></li>
          <li data-target="#myCarousel" data-slide-to="1"><a href="#">ALCOHOLEMIAS<small></small></a>
          </li>
    ...
    <div class="contact" id="contact">
      <div class="container">
        ...
        <?php
          ...
          ?>
        <?php
          echo "<div class= 'col-md-12 col-sm-12 grid_12' style='padding: 4em;'>
               <h3 style='color:#C0D4E0'>Gracias por contactar con nosotros, en breves nos pondremos en contacto con usted.</h3>
          </div>";
           sleep(3);
        ...
        <div class="footer-info">
          ...
          <div class="col-md-4 col-sm-4 footer-info-grid address">
            ...
            <div class="col-md-12 col-sm-12 footer-info-grid" >
              <p style="text-align: center"> &copy; <? echo date ("Y"); ?> Guarchabogados.com, Todos los derechos reservados.</p>
            </div>
            <div class="clearfix"></div>
          </div>
        </div>
